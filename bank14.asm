; da65 V2.19 - Git a5e69e7
; Created:    2022-07-01 00:39:13
; Input file: original.nes
; Page:       1
...
LA66A:
        ...
        lda     $04C0                           ; A670 AD C0 04                 ...
        and     #$10                            ; A673 29 10                    ).
        beq     LA67A                           ; A675 F0 03                    ..
LA677:
        jmp     LC85C                           ; A677 4C 5C C8                 L\.
...
; ----------------------------------------------------------------------------
        ...
        sta     $49                             ; A877 85 49                    .I
        lda     #$0F                            ; A879 A9 0F                    ..
        sta     $04A8                           ; A87B 8D A8 04                 ...
        lda     #$78                            ; A87E A9 78                    .x
        sta     $BE                             ; A880 85 BE                    ..
LA882:
        jsr     L9BD9                           ; A882 20 D9 9B                  ..
        jsr     L9E16                           ; A885 20 16 9E                  ..
        jsr     L96C2                           ; A888 20 C2 96                  ..
        jsr     L9E24                           ; A88B 20 24 9E                  $.
        lda     #$01                            ; A88E A9 01                    ..
        jsr     LC011                           ; A890 20 11 C0                  ..
        jsr     L94A2                           ; A893 20 A2 94                  ..
        jsr     L9442                           ; A896 20 42 94                  B.
        dec     $BE                             ; A899 C6 BE                    ..
        bne     LA882                           ; A89B D0 E5                    ..
        lda     #$01                            ; A89D A9 01                    ..
        sta     $0700                           ; A89F 8D 00 07                 ...
        dec     $A5                             ; A8A2 C6 A5                    ..
        bpl     LA8F3                           ; A8A4 10 4D                    .M
        lda     #$33                            ; A8A6 A9 33                    .3
        sta     $0700                           ; A8A8 8D 00 07                 ...
        jsr     L974A                           ; A8AB 20 4A 97                  J.
        lda     #$00                            ; A8AE A9 00                    ..
        sta     $1F                             ; A8B0 85 1F                    ..
        sta     $E000                           ; A8B2 8D 00 E0                 ...
        sta     $4D                             ; A8B5 85 4D                    .M
        sta     $21                             ; A8B7 85 21                    .!
        sta     $23                             ; A8B9 85 23                    .#
        sta     $48                             ; A8BB 85 48                    .H
        ...
        and     #$FC                            ; A8C7 29 FC                    ).
        sta     $10                             ; A8C9 85 10                    ..
        jsr     L9E16                           ; A8CB 20 16 9E                  ..
        jsr     L95E8                           ; A8CE 20 E8 95                  ..
        ldx     #$00                            ; A8D1 A2 00                    ..
        jsr     L9B9A                           ; A8D3 20 9A 9B                  ..
LA8D6:
        jsr     L9BD9                           ; A8D6 20 D9 9B                  ..
        lda     #$01                            ; A8D9 A9 01                    ..
        jsr     LC011                           ; A8DB 20 11 C0                  ..
        jsr     L94A2                           ; A8DE 20 A2 94                  ..
        lda     $13                             ; A8E1 A5 13                    ..
        and     #$10                            ; A8E3 29 10                    ).
        beq     LA8D6                           ; A8E5 F0 EF                    ..
        jsr     L95E8                           ; A8E7 20 E8 95                  ..
        jsr     L96B7                           ; A8EA 20 B7 96                  ..
        lda     #$02                            ; A8ED A9 02                    ..
        sta     $B6                             ; A8EF 85 B6                    ..
        bne     LA8FF                           ; A8F1 D0 0C                    ..
LA8F3:
        lda     #$09                            ; A8F3 A9 09                    ..
        sta     $48                             ; A8F5 85 48                    .H
        lda     #$00                            ; A8F7 A9 00                    ..
...
LA8FF:
        sta     $B6                             ; A8FF 85 B6                    ..
        jsr     L9E16                           ; A901 20 16 9E                  ..
        jsr     L9E24                           ; A904 20 24 9E                  $.
        jsr     L9699                           ; A907 20 99 96                  ..
        jsr     L9FD3                           ; A90A 20 D3 9F                  ..
        jsr     L9BD9                           ; A90D 20 D9 9B                  ..
        jmp     LCD4B                           ; A910 4C 4B CD                 LK.
...
; ----------------------------------------------------------------------------
        lda     $4D                             ; AD7B A5 4D                    .M
        beq     LAD92                           ; AD7D F0 13                    ..
        .byte   $A9,$00,$85,$4D,$A5,$7E,$C9,$2D ; AD7F A9 00 85 4D A5 7E C9 2D  ...M.~.-
        .byte   $90,$07,$A9,$28,$85,$7E,$4C,$C3 ; AD87 90 07 A9 28 85 7E 4C C3  ...(.~L.
        .byte   $CD,$C6,$7E                     ; AD8F CD C6 7E                 ..~
; ----------------------------------------------------------------------------
LAD92:
        jmp     LCDC3                           ; AD92 4C C3 CD                 L..

; ----------------------------------------------------------------------------
        ldx     $7E                             ; AD95 A6 7E                    .~
        lda     $8240,x                         ; AD97 BD 40 82                 .@.
        lsr     a                               ; AD9A 4A                       J
        lsr     a                               ; AD9B 4A                       J
        sta     $7E                             ; AD9C 85 7E                    .~
        jsr     LCEC5                           ; AD9E 20 C5 CE                  ..
        jsr     LCEB7                           ; ADA1 20 B7 CE                  ..
        jmp     LCDC3                           ; ADA4 4C C3 CD                 L..
...
; ----------------------------------------------------------------------------
        ...
        jsr     L974A                           ; B675 20 4A 97                  J.
        lda     #$7F                            ; B678 A9 7F                    ..
        jsr     L95EA                           ; B67A 20 EA 95                  ..
        ldx     #$3C                            ; B67D A2 3C                    .<
        jsr     LD78F                           ; B67F 20 8F D7                  ..
        ldx     #$09                            ; B682 A2 09                    ..
        jsr     L9B9A                           ; B684 20 9A 9B                  ..
        jsr     L9743                           ; B687 20 43 97                  C.
        ldx     #$00                            ; B68A A2 00                    ..
        jsr     LD78F                           ; B68C 20 8F D7                  ..
        jsr     L974A                           ; B68F 20 4A 97                  J.
        ldx     #$3C                            ; B692 A2 3C                    .<
        jsr     LD78F                           ; B694 20 8F D7                  ..
        jsr     LC820                           ; B697 20 20 C8                   .
        lda     #$36                            ; B69A A9 36                    .6
...
LB721:
        ...
        jsr     L974A                           ; B742 20 4A 97                  J.
        inc     $E0                             ; B745 E6 E0                    ..
        lda     #$00                            ; B747 A9 00                    ..
        sta     $1F                             ; B749 85 1F                    ..
        sta     $E000                           ; B74B 8D 00 E0                 ...
        jmp     LD62C                           ; B74E 4C 2C D6                 L,.
...
LB7DF:
        ...
        lda     $04C0                           ; B7E9 AD C0 04                 ...
        and     #$F5                            ; B7EC 29 F5                    ).
        sta     $04C0                           ; B7EE 8D C0 04                 ...
LB7F1:
        ldx     #$00                            ; B7F1 A2 00                    ..
        stx     $53                             ; B7F3 86 53                    .S
...
LB832:
        ...
        lda     $12                             ; B83D A5 12                    ..
        lsr     a                               ; B83F 4A                       J
        bcs     LB84C                           ; B840 B0 0A                    ..
        lsr     a                               ; B842 4A                       J
        bcc     LB851                           ; B843 90 0C                    ..
        bit     $04F0                           ; B845 2C F0 04                 ,..
        bvs     LB851                           ; B848 70 07                    p.
        bvc     LB856                           ; B84A 50 0A                    P.
LB84C:
        bit     $04F0                           ; B84C 2C F0 04                 ,..
        bvs     LB856                           ; B84F 70 05                    p.
LB851:
        lda     #$0C                            ; B851 A9 0C                    ..
        jmp     L9278                           ; B853 4C 78 92                 Lx.

; ----------------------------------------------------------------------------
LB856:
        lda     #$0D                            ; B856 A9 0D                    ..
        jmp     L9278                           ; B858 4C 78 92                 Lx.
